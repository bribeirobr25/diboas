...
export class IntegrationManager {
  ...
  async _initializeAuthProviders() {
    ...
    if (config.social?.enabled) {
      ...
      this.authRegistry.registerProvider('social', socialProvider)
    ...
    if (config.email?.enabled) {
      ...
      this.authRegistry.registerProvider('email', emailProvider)
  ...
  async _initializePaymentProviders() {
    ...
    if (config.stripe?.enabled) {
      ...
      this.paymentRegistry.registerProvider('stripe', stripeProvider)
    ...
    if (config.plaid?.enabled) {
      ...
      this.paymentRegistry.registerProvider('plaid', plaidProvider)
    ...
    if (config.paypal?.enabled) {
      ...
      this.paymentRegistry.registerProvider('paypal', paypalProvider)
  ...
  async _initializeWalletProviders() {
    ...
    if (config.metamask?.enabled) {
      ...
      this.walletRegistry.registerProvider('metamask', metamaskProvider)
    ...
    if (config.phantom?.enabled) {
      ...
      this.walletRegistry.registerProvider('phantom', phantomProvider)
    ...
    if (config.coinbase?.enabled) {
      ...
      this.walletRegistry.registerProvider('coinbase', coinbaseWalletProvider)
  ...
  async _initializeKYCProviders() {
    ...
    if (config.jumio?.enabled) {
      ...
      this.kycRegistry.registerProvider('jumio', jumioProvider)
    ...
    if (config.onfido?.enabled) {
      ...
      this.kycRegistry.registerProvider('onfido', onfidoProvider)
  ...
  async _initializeTwoFAProviders() {
    ...
    if (config.twilio?.enabled) {
      ...
      this.twoFARegistry.registerProvider('sms', twilioProvider)
    ...
    if (config.authy?.enabled) {
      ...
      this.twoFARegistry.registerProvider('app', authyProvider)
  ...
  async _initializeOnChainProviders() {
    ...
    if (config.ethereum?.enabled) {
      ...
      this.onChainRegistry.registerProvider('ethereum', ethereumProvider)
    ...
    if (config.solana?.enabled) {
      ...
      this.onChainRegistry.registerProvider('solana', solanaProvider)
    ...
    if (config.bitcoin?.enabled) {
      ...
      this.onChainRegistry.registerProvider('bitcoin', bitcoinProvider)
